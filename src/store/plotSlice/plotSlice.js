...
const plotSlice = createSlice({
    ...
    reducers: {
        ...
        /**
         * This reducer toggles the update switch.
         * This happens every time, when new data is fetched.
         *
         * @param {object} state the current state of the store
         */
        setUpdateSwitch(state) {
            console.log("update...");
            state.generalSettings.updateSwitch = !state.generalSettings.updateSwitch;
            console.log(state.generalSettings.updateSwitch);
        },
...
/**
 * This selector allows components to select the current state of the update switch.
 *
 * @param {object} state the global redux state
 * @returns {boolean} the current state of the update switch
 */
export const selectUpdateSwitch = state => state.plot.generalSettings.updateSwitch;
