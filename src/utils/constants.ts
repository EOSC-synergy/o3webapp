/**
 * A module defining all constants that are shared between different components. It contains default
 * values and settings for those components.
 *
 * @module Constants
 ...
 *
 * Modify this object to change the name or the models that appear when the WebApp is initially
 * loaded.
 *
 * @category Utils
 */
...
/**
 * The mean: this appears in the model group card and is used to identify its statistical value
 * settings.
 *
 * @category Utils
 */
...
/**
 * The standard deviation: this appears in the model group card and is used to identify its
 * statistical value settings.
 *
 * @category Utils
 */
export const std = 'standard deviation';
/**
 * The median: this appears in the model group card and is used to identify its statistical value
 * settings.
 *
 * @category Utils
 */
...
/**
 * The percentile: this appears in the model group card and is used to identify its statistical
 * value settings.
 *
 * @category Utils
 */
...
/**
 * The statistical values that are computable are listed here as an "enum"
 *
 * @category Utils
 */
...
/**
 * This extended sv list is used in the calculation to handle some changes that came up after the
 * specification / design phase: standard deviation is not one but TWO lines. Same goes for
 * percentile which is lower- AND upper-percentile.
 *
 * @category Utils
 */
