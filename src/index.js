...
const reloadInitialData = () => {
    store.dispatch(fetchPlotData({
        ...
        startYear: 1960, 
        endYear: 2100, 
        modelList: store.getState().api.models.data.slice(0, 30), // not all models for faster testing!
        refYear: 1980,
    ...
    store.dispatch(fetchPlotData({
        ...
        startYear: 1960, 
        endYear: 2100, 
        modelList: store.getState().api.models.data.slice(0, 30), //.slice(0, 10), // not all models for faster testing!
        refYear: 1980,
        refModel: "SBUV_GSFC_merged-SAT-ozone",
    }));
}
