...
describe('test DiscardChangesModal rendering', () => {
    ...
    it('renders without crashing', () => {
        ...
        render(<DiscardChangesModal isOpen={true} onClose={mockFunction} saveChanges={mockFunction} discardChanges={mockFunction} />);
    });

    
    it('renders correctly when opened', () => {
        const mockFunction = jest.fn();
        const { baseElement, getByTestId } = render(<DiscardChangesModal isOpen={true} onClose={mockFunction} saveChanges={mockFunction} discardChanges={mockFunction} />);
    ...
    it('renders correctly when closed', () => {
        const mockFunction = jest.fn();
        const { baseElement } = render(<DiscardChangesModal isOpen={false} onClose={mockFunction} saveChanges={mockFunction} discardChanges={mockFunction} />);
        expect(baseElement).toMatchSnapshot();
